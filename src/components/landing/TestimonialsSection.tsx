...
import type { Testimonial } from "../../assets/data"
                ...
                <div className="relative">
                    <div className="text-center">
                        ...
                        <p className="mt-4 max-w-3xl mx-auto text-xl text-gray-500">
                            Don't just take our word for it. Hear from our satisfied users who have experienced the benefits of our secure file sharing platform.
                        </p>
                    </div>
                            ...
                            <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden transform transition duration-500 hover:scale-105">
                                <div className="p-8">
                                    <div className="flex items-center">
                                        <div className="flex-shrink-0 h-12 w-12 rounded-full bg-gray-200">
                                            <img src={testimonial.avatarUrl} alt="" className="h-12 w-12 rounded-full" />
                                        </div>
                                        <div className="ml-4">
