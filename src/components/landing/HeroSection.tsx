            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
                    <div className="text-center">
                        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            ...
                            <span className="block text-purple-500">Sharey</span>
                        </h1>
                        <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                            Upload and share your files with ease. Our secure platform ensures your data is protected while providing a seamless sharing experience.
                        </p>
                ...
                <div className="my-8 text-center">
                    <div className="mt-4 text-base text-gray-500">
                        <p>Experience the future of file sharing with Sharey. Whether you're sharing documents, photos, or videos, our platform makes it easy and secure.</p>
                    </div>
                </div>
            </div>
        </div>
